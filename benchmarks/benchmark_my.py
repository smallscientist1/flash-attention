...
def time_fwd_bwd(func, *args, **kwargs):
    ...
    time_b = float('inf')
    return time_f[1].mean, float('inf')
    '''
...
bs_seqlen_vals = [(4, 2048)] # [(32, 512), (16, 1024), (8, 2048), (4, 4096), (2, 8192), (1, 16384)]
causal_vals = [False, True]
headdim_vals = [64, 128,192, 256 ]# , 512] # 64, 128, 
nheads = 8 # dim = 2048
dropout_p = 0.0
    ...
    for headdim in headdim_vals:
        for batch_size, seqlen in bs_seqlen_vals:
            ...
            for method in methods:
                ...
                print(
                    f"{method} fwd: {time_f[config,method]} s, "
                    f"bwd: {time_b[config,method]} s, "
                    f"fwd + bwd: {time_f_b[config,method]} s"
                )
                print(
